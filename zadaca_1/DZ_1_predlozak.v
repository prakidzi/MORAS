...
Proof. 
  assert (P : forall u v : list B, NotL (AndL u v) = OrL (NotL u) (NotL v)).
  {
    intros u. induction u.
    - reflexivity.
    - destruct v.
      -- reflexivity.
      -- simpl. rewrite IHu. destruct a, b; reflexivity.
  }
  assert (Q : forall u : list B, NotL (NotL u) = u).
  {
    intros. induction u.
    - reflexivity.
    - simpl. rewrite IHu. destruct a; reflexivity.
  }
  intros H. simpl. rewrite P, Q, Q. reflexivity.
Admitted.
